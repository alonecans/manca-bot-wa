...
const bottt = (prefix) => {
return `
*ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴍᴀɴᴄᴀ ʙᴏᴛ ʜᴀʀᴀᴘ ғᴏʟʟᴏᴡ ᴅᴜʟᴜ*
...
│ ɢᴀᴍᴀᴜ ᴅᴏɴᴀsɪ? ғᴏʟʟᴏᴡ ᴀᴊᴀ ɪɢ ɴʏᴀ
┬
╰──────「 *_ᴅɴꜱʙᴏᴛ_* 」
`
}
...
const limitend = (pushname2) => {
        return`*ᴍᴀᴀғ ${pushname2} ʟɪᴍɪᴛ ʜᴀʀɪ ɪɴɪ ʜᴀʙɪꜱ*\n*ʟɪᴍɪᴛ ᴅɪ ʀᴇꜱᴇᴛ ꜱᴇᴛɪᴀᴘ ᴊᴀᴍ 12:00 ᴡɪʙ ᴛᴇɴɢᴀʜ ᴍᴀʟᴀᴍ*`
}
